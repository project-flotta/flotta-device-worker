...
func (m *MockOsExecCommands) IsRpmOstreeAvailable() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsRpmOstreeAvailable")
	ret0, _ := ret[0].(bool)
	return ret0
}
...
func (mr *MockOsExecCommandsMockRecorder) IsRpmOstreeAvailable() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsRpmOstreeAvailable", reflect.TypeOf((*MockOsExecCommands)(nil).IsRpmOstreeAvailable))
}
